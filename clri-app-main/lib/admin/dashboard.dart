      ...
      body: users.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
               ...
               var l_objEmail = user['Attributes'].firstWhere((attr) => attr['Name'] == 'email');
               
                final email =  l_objEmail['Value'];
                
                print('email: ${email}');

                var l_objIsVarified = user['Attributes'].firstWhere((attr) => attr['Name'] == 'custom:isVarified',  orElse: () => null);
                
                print('l_objIsVarified: ${l_objIsVarified}');

                bool isToggled  = false;

                if(  l_objIsVarified != null)
                {
                     isToggled =  l_objIsVarified['Value'] == '1';
